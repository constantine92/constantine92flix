...
movie.reviews.create!(name: "Bruce Wayne", stars: 5, comment: "I'm batman")
movie.reviews.create!(name: "Joe Schumacher", stars: 4, comment: "That batman suit lacks nipples")
